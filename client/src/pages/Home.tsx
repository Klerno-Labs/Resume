      ...
      <nav className="sticky top-0 z-50 w-full border-b bg-background/80 backdrop-blur-md supports-backdrop-filter:bg-background/60">
        <div className="container flex h-16 items-center justify-between px-4 md:px-8 mx-auto max-w-7xl">
          ...
          <div className="hidden md:flex gap-8 text-sm font-medium text-muted-foreground">
            ...
            <a href="/ai-resume-builder" className="hover:text-primary transition-colors">
              AI Builder
            </a>
          ...
          <div className="flex gap-4 items-center">
            {user ? (
              ...
              <>
                ...
                <Link href="/auth">
                  <button
                    className="bg-foreground text-background px-4 py-2 rounded-full text-sm font-medium hover:bg-primary hover:text-white transition-all shadow-lg hover:shadow-primary/25"
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="container relative z-10 px-4 mx-auto max-w-7xl text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
            Instant AI resume repair. We fix formatting, rewrite weak bullets into quantifiable
            achievements, and optimize for ATS algorithms in seconds.
          </p>
        ...
        <div className="container px-4 mx-auto max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4">
              Why resumes fail (and how we fix them)
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Most qualified candidates get rejected by robots before a human ever sees their
              application.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Upload your current resume in PDF, DOCX, or paste text directly
              </p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 rounded-full bg-primary/10 text-primary flex items-center justify-center text-2xl font-bold mx-auto mb-4">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Get your optimized resume and start landing more interviews
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="pricing" className="py-24">
        <div className="container px-4 mx-auto max-w-7xl">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground">
              Invest in your career for less than the cost of lunch.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="p-8 rounded-2xl border bg-card flex flex-col">
              ...
              <ul className="space-y-3 mb-8 flex-1">
                <li className="flex gap-2 text-sm">
                  <CheckCircle2 className="w-4 h-4 text-green-500" /> 1 Resume Optimization
                </li>
                <li className="flex gap-2 text-sm">
                  <CheckCircle2 className="w-4 h-4 text-green-500" /> PDF & DOCX Export
                </li>
                <li className="flex gap-2 text-sm text-muted-foreground">
                  <CheckCircle2 className="w-4 h-4 text-muted" /> ATS Report
                </li>
              </ul>
              <PricingModal
                defaultPlan="basic"
                trigger={
                  <button className="w-full py-2.5 rounded-lg border font-medium hover:bg-secondary transition-colors">
                    Choose Basic
                  </button>
                }
              />
            ...
            <div className="p-8 rounded-2xl border-2 border-primary bg-card relative flex flex-col shadow-xl scale-105 z-10">
              ...
              <ul className="space-y-3 mb-8 flex-1">
                <li className="flex gap-2 text-sm">
                  <CheckCircle2 className="w-4 h-4 text-green-500" /> 3 Resume Optimizations
                </li>
                <li className="flex gap-2 text-sm">
                  <CheckCircle2 className="w-4 h-4 text-green-500" /> PDF & DOCX Export
                </li>
                <li className="flex gap-2 text-sm">
                  <CheckCircle2 className="w-4 h-4 text-green-500" /> Detailed ATS Report
                </li>
                <li className="flex gap-2 text-sm">
                  <CheckCircle2 className="w-4 h-4 text-green-500" /> Keyword Optimization
                </li>
              </ul>
              <PricingModal
                defaultPlan="pro"
                trigger={
                  <button className="w-full py-2.5 rounded-lg bg-primary text-white font-medium hover:bg-primary/90 transition-colors shadow-lg shadow-primary/25">
                    Choose Pro
                  </button>
                }
              />
            ...
            <div className="p-8 rounded-2xl border bg-card flex flex-col">
              ...
              <ul className="space-y-3 mb-8 flex-1">
                <li className="flex gap-2 text-sm">
                  <CheckCircle2 className="w-4 h-4 text-green-500" /> Unlimited Optimizations
                </li>
                <li className="flex gap-2 text-sm">
                  <CheckCircle2 className="w-4 h-4 text-green-500" /> AI Cover Letters
                </li>
                <li className="flex gap-2 text-sm">
                  <CheckCircle2 className="w-4 h-4 text-green-500" /> LinkedIn Profile Rewrite
                </li>
                <li className="flex gap-2 text-sm">
      ...
      <section id="faq" className="py-24 bg-secondary/20">
        <div className="container px-4 mx-auto max-w-4xl">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground">
              Everything you need to know about optimizing your resume
            </p>
          </div>
