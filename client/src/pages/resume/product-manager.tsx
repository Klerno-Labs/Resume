...
export default function ResumeProductManager() {
  ...
  const description =
    'AI-powered resume optimization for product managers — surface impact, metrics, roadmaps, and cross-functional leadership for ATS and hiring managers.';
  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      <Seo
        ...
        canonical="https://rewriteme.app/resume/product-manager"
      ...
      <main className="container mx-auto px-4 py-20 max-w-4xl">
        ...
        <p className="text-muted-foreground mb-6">
          AI-driven resume updates for PMs — emphasize product outcomes, metrics, and leadership in
        ...
        <section className="mb-8">
          ...
          <Link href="/ai-resume-builder">
            <button className="bg-primary text-white px-4 py-2 rounded">Optimize PM Resume</button>
          </Link>
        </section>
