...
export default function ResumeSoftwareEngineer() {
  ...
  const description =
    'AI-powered resume tips and optimization for Software Engineers — keyword matching, ATS formatting, and achievement-based bullet rewrites.';
  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      <Seo
        ...
        canonical="https://rewriteme.app/resume/software-engineer"
      ...
      <main className="container mx-auto px-4 py-20 max-w-4xl">
        ...
        <p className="text-muted-foreground mb-6">
          Best practices and AI-driven rewrites to help software engineers pass ATS and impress
          hiring managers.
        </p>
        ...
        <section className="mb-8">
          ...
          <Link href="/ai-resume-builder">
            <button className="bg-primary text-white px-4 py-2 rounded">
              Optimize Software Engineer Resume
            </button>
          </Link>
        </section>
