      ...
      <div className="flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md space-y-8">
          <div className="space-y-2 text-center">
            <Link href="/">
              <img src="/rewritemelogo.png" alt="RewriteMe" className="h-14 w-auto mx-auto mb-4 cursor-pointer" />
            </Link>
      ...
      <div className="hidden lg:flex relative bg-slate-900 items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg text-center p-8">
          <div className="mb-8 flex justify-center">
            <div className="w-24 h-24 bg-primary/20 rounded-full flex items-center justify-center backdrop-blur-lg border border-primary/30">
