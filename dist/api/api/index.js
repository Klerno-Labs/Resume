...
import { getS3Client, PutObjectCommand } from '../server/lib/s3';
...
async function verifySchema() {
  ...
  `;
    ...
    if (missing.length > 0) {
        throw new Error(`Missing required schema columns on resumes table: ${missing.join(', ')}. Run npm run db:push.`);
    }
